...
- run `` git clone https://github.com/FahimAnzamDip/hamro-pos.git ``
...
> **Important Note:** "Hamro POS" uses Laravel Snappy Package for PDFs. If you are using Linux then no configuration is needed. But in other Operating Systems please refer to [Laravel Snappy Documentation](https://github.com/barryvdh/laravel-snappy).
...
## Demo
![Hamro POS](public/images/screenshot.jpg)
